...
char *LED_MSG_3 = "Press 1 through 4 to toggle LEDssss\r\n";
char *LED_MSG_4 = ">";
	...
	do {
		...
		switch (rcvdChar)
		{
			case '1':
				...
				LM8_WRITE_MEM_BYTE(SPI_CONTROLLER_BASE_ADDRESS + 0, ~0xA);
				break;
			case '2':
				MICO_GPIO_WRITE_DATA_BYTE0 (pGpio->base, ~0x2);
				LM8_WRITE_MEM_BYTE(SPI_CONTROLLER_BASE_ADDRESS + 0, ~0xB);
				break;
			case '3':
				MICO_GPIO_WRITE_DATA_BYTE0 (pGpio->base, ~0x4);
				LM8_WRITE_MEM_BYTE(SPI_CONTROLLER_BASE_ADDRESS + 0, ~0xC);
				break;
			case '4':
				MICO_GPIO_WRITE_DATA_BYTE0 (pGpio->base, ~0x8);
				LM8_WRITE_MEM_BYTE(SPI_CONTROLLER_BASE_ADDRESS + 0, ~0xD);
				break;
			default:
				break;
		}
...
int main (void)
{
	...
	MicoPassthruCtx_t *slave_pt = &slave_passthru_SPI_controller;
