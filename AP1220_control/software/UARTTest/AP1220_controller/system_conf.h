...
#define PLATFORM_NAME         "AP1220_controller"
#define USE_PLL               (0)
#define CPU_FREQUENCY         (88670000)
...
/*
 * SPI_controller component configuration
 */
#define SPI_CONTROLLER_NAME  "SPI_controller"
#define SPI_CONTROLLER_BASE_ADDRESS  (0x80000100)
#define SPI_CONTROLLER_SIZE  (256)
#define SPI_CONTROLLER_IRQ (1)
#define SPI_CONTROLLER_CHARIO_IN        (0)
#define SPI_CONTROLLER_CHARIO_OUT       (0)
#define SPI_CONTROLLER_ADDRESS_LOCK  (1)
#define SPI_CONTROLLER_DISABLE  (0)
#define SPI_CONTROLLER_WB_DAT_WIDTH  (8)
#define SPI_CONTROLLER_WB_SEL_WIDTH  (4)
#define SPI_CONTROLLER_WB_ADR_WIDTH  (32)
