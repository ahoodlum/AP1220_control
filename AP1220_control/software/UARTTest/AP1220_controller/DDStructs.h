...
#define MICO8_CPU_CLOCK_MHZ (88670000)
...
/* slave_passthru instance SPI_controller*/
extern struct st_MicoPassthruCtx_t slave_passthru_SPI_controller;

/* declare SPI_controller instance of slave_passthru */
